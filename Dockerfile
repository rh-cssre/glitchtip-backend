...
COPY --chown=app --from=build-python /usr/local/lib/python3.10/site-packages/ /usr/local/lib/python3.10/site-packages/
COPY --chown=app --from=build-python /usr/local/bin/ /usr/local/bin/
